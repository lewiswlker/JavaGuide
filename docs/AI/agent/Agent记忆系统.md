...
记忆层要解决两件事：当前这轮对话里，关键事实别丢；隔几天再开一个新 Session 时，还能把与用户相关的偏好、背景和历史决策捞回来。下面会按记忆的表征和功能分类、读写生命周期、短期和长期实现、主流产品与检索优化、Markdown 记忆这几条线展开。滑动窗口怎么裁、overload 怎么卸，和同站的 [《上下文工程实战指南》](./上下文工程.md) 有交集，两篇可以对着看。
...
![AI Agent 记忆系统架构](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-arch.png)
...
![记忆操作的生命周期](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-lifestyle.png)
...
![长期记忆与 RAG（检索增强生成）的区别](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-rag-vs-memory.svg)
...
![记忆系统的高级演化机制](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-evolution.png)
...
![长期记忆的检索优化策略](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-retrieval-optimization.png)
...
![Markdown 记忆和传统长期记忆的适用边界](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-markdown-memory-boundary.svg)
