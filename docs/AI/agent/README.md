...
1. [一文搞懂 AI Agent 核心概念](./Agent核心概念.md)：先建立 Agent 的整体认知。
2. [大模型提示词工程实践指南](./提示词工程.md)、[上下文工程实战指南](./上下文工程.md)：理解指令和上下文如何共同影响输出。
3. [AI Agent 记忆系统](./Agent记忆系统.md)：补齐短期记忆、长期记忆和记忆生命周期。
4. [万字拆解 MCP 协议](./MCP协议.md)、[万字详解 Agent Skills](./Agent-Skills.md)：理解工具接入和能力扩展。
5. [一文搞懂 Harness Engineering](./Harness工程.md)、[AI 工作流中的 Workflow、Graph 与 Loop](./AI工作流.md)：进入生产级 Agent 工程化。

## 核心文章

- [一文搞懂 AI Agent 核心概念](./Agent核心概念.md)：梳理 AI Agent 的演进脉络，讲清 Agent Loop、Context Engineering、Tools 注册等基础概念。
- [AI Agent 记忆系统](./Agent记忆系统.md)：深入理解短期记忆与长期记忆设计，掌握记忆存储形式、生命周期操作与生产级工程优化策略。
- [大模型提示词工程实践指南](./提示词工程.md)：从 Prompt 四要素、常见技巧讲到企业级安全实践。
- [上下文工程实战指南](./上下文工程.md)：掌握静态规则编排、动态信息挂载、Token 预算降级等关键技术。
- [万字详解 Agent Skills](./Agent-Skills.md)：理解 Skills 的设计理念，以及 Skills 与 Prompt、MCP、Function Calling 的本质区别。
- [万字拆解 MCP 协议](./MCP协议.md)：理解 MCP 协议的核心概念、架构设计和生产级最佳实践。
- [一文搞懂 Harness Engineering](./Harness工程.md)：拆解 OpenAI、Anthropic、Stripe 等团队在 Agent 工程化上的实践思路。
- [AI 工作流中的 Workflow、Graph 与 Loop](./AI工作流.md)：对比传统工作流与 AI 工作流的差异，覆盖 Spring AI Alibaba 和 LangGraph 实现。
