...
![ReAct-LLM](https://oss.javaguide.cn/github/项目介绍/AI/agent/ReAct-LLM.png)
...
![ReAct 模式流程](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-react-flow.png)
...
![Multi-Agent 系统架构](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-multi-agent-arch.png)
...
![A2A 协议架构](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-a2a.png)
...
![智能体工作流核心模式](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-agentic-workflows.png)
