...
![FC/MCP/Agent 三层关系图](https://oss.javaguide.cn/github/项目介绍/AI/skills/mcp-fc-agent-layer.png)
...
![MCP 四层架构](https://oss.javaguide.cn/github/项目介绍/AI/skills/mcp-four-layer-architecture.png)
...
![MCP 调用时序图](https://oss.javaguide.cn/github/项目介绍/AI/skills/mcp-call-seq.png)
...
![MCP 传输方式选择](https://oss.javaguide.cn/github/项目介绍/AI/skills/mcp-transport-decision.png)
