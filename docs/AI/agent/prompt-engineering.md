...
> 前置知识：本文默认你已经理解 Token、上下文窗口、Temperature、Top-p 等 LLM 底层概念。如果还不熟，可以先看[《万字拆解 LLM 运行机制：Token、上下文与采样参数》](../大模型基础/llm-operation-mechanism.md)。
...
![Prompt 四要素框架](https://oss.javaguide.cn/github/项目介绍/AI/context-engineering/prompt-four-element-framework.svg)
...
![六大核心技巧](https://oss.javaguide.cn/github/项目介绍/AI/context-engineering/prompt-six-core-techniques.svg)
...
![任务分解](https://oss.javaguide.cn/github/项目介绍/AI/context-engineering/task-decomposition.svg)
...
![结构化输出格式对比](https://oss.javaguide.cn/github/项目介绍/AI/context-engineering/structured-output-formats.svg)
...
![prompt-injection-protection-three-layer-defense-in-depth-system](https://oss.javaguide.cn/github/项目介绍/AI/context-engineering/prompt-injection-protection-three-layer-defense-in-depth-system.svg)
