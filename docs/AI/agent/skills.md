...
![查找自己需要和热门的 Skills](https://oss.javaguide.cn/github/项目介绍/AI/skills/skillssh.png)

![Superpowers 内置的 skills](https://oss.javaguide.cn/github/项目介绍/AI/skills/superpowers-skills.png)
...
![渐进式披露](https://oss.javaguide.cn/github/项目介绍/AI/skills/skills-progressive-disclosure.svg)

就像查书一样。你不会先把整本书背下来，而是先看目录，确定章节，再翻到具体那一页。

一般可以分成三层：

![渐进式披露（三层模型）](https://oss.javaguide.cn/github/项目介绍/AI/skills/skills-progressive-disclosure-three-layer-model.png)
...
![Skill 路由流程](https://oss.javaguide.cn/github/项目介绍/AI/skills/skills-router.svg)
