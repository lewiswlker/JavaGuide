...
![传统 Workflow 与 AI Workflow 对比](https://oss.javaguide.cn/github/项目介绍/AI/workflow/traditional-vs-ai-workflow.svg)
...
![Loop 概览：循环机制示意](https://oss.javaguide.cn/github/项目介绍/AI/workflow/loop-mechanism.svg)
...
![Workflow、Graph、Loop 三者关系概览](https://oss.javaguide.cn/github/项目介绍/AI/workflow/workflow-graph-loop-relation.svg)
...
![高抽象与低抽象工作流对比](https://oss.javaguide.cn/github/项目介绍/AI/workflow/abstraction-comparison.svg)
...
![Graph 核心元素：Node、Edge、State](https://oss.javaguide.cn/github/项目介绍/AI/workflow/graph-core-elements.svg)
