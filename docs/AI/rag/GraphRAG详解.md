...
![什么是 RAG？](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-simplified-architecture-diagram.jpeg)
...
![什么是 GraphRAG？](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-simplified-architecture-diagram.png)
...
![传统向量 RAG 的局限性](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-vector-rag-limitation.png)
...
![GraphRAG 和传统向量 RAG 的本质区别](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-vs-rag.png)
...
![GraphRAG 的核心概念](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-core-concept.png)
...
![GraphRAG 构建阶段：从文档到图谱](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-build-process.png)
...
![GraphRAG 查询阶段：先判断问题类型](https://oss.javaguide.cn/github/项目介绍/AI/rag/graphrag-query-routing.png)
...
- [LlamaIndex PropertyGraphIndex](https://developers.llamaindex.ai/python/常用框架/module_guides/indexing/lpg_index_guide/)
