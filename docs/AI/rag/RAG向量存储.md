...
![Embedding 和向量检索是什么关系？](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-embedding-vector-retrieval.png)
...
![RAG 场景为什么需要向量数据库？](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-why-need-vector-store.png)
...
![向量索引算法分类](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-vector-index-algorithms-Bjze1jhj.png)
...
这里以 [《SpringAI 智能面试平台+RAG 知识库》](https://javaguide.cn/星球专栏/interview-guide.html)项目为例。
...
![HNSW 索引架构](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-hnsw-architecture.png)
...
这里以 [《SpringAI 智能面试平台+RAG 知识库》](https://javaguide.cn/星球专栏/interview-guide.html)项目为例。这个项目需要同时存结构化数据，比如简历、面试记录，也要存向量数据，也就是文档 Embedding。
...
![VECTOR 列不能用作任何类型的键，包括主键、外键、唯一键和分区键](https://oss.javaguide.cn/github/项目介绍/AI/rag/mysql9-vector-cannot-be-used-as-any-type-of-key.png)
