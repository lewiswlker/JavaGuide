...
![RAG 示意图](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-simplified-architecture-diagram.jpeg)

## 为什么需要 RAG？

![RAG（检索增强生成）如何解决 LLM 的核心挑战](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-llm-challenges.png)
...
![索引和检索阶段的简化流程图](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-rag-engineering-link.png)
...
检索效果不稳定时，问题往往出在查询改写、召回策略、排序或上下文质量上。优化方向可以看 [RAG 优化篇](./RAG检索优化.md)。
...
![Embedding：把文本映射到语义空间](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-2-embedding-map-text-to-semantic-space.png)
...
![RAG 与传统搜索引擎的区别](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-rag-vs-search-engine.png)
...
![RAG 演进阶段](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-2-evolution-stages.png)
...
Naive RAG 是起点，能跑通 Demo，但离生产通常还有距离。Advanced RAG 开始处理召回质量、噪声过滤和排序问题。Modular RAG 把各环节拆成可替换模块，更适合复杂场景。具体优化策略可以继续看 [RAG 优化篇](./RAG检索优化.md)。
