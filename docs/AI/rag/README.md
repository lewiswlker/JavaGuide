...
1. [万字详解 RAG 基础概念](./RAG基础.md)：先理解 RAG 的核心流程、优势和局限。
2. [RAG 文档处理与切分策略](./RAG文档处理.md)：理解文档进入索引前的处理链路。
3. [万字详解 RAG 向量索引算法和向量数据库](./RAG向量存储.md)：补齐向量索引和数据库选型基础。
4. [万字详解 RAG 检索优化](./RAG检索优化.md)：掌握召回、重排、改写和上下文压缩。
5. [万字详解 GraphRAG](./GraphRAG详解.md)、[RAG 知识库文档更新策略](./RAG知识更新.md)：进一步理解复杂知识组织和持续更新。

## 核心文章

- [万字详解 RAG 基础概念](./RAG基础.md)：理解 RAG 的工作流程、适用场景和局限性。
- [RAG 文档处理与切分策略](./RAG文档处理.md)：涵盖文件解析、清洗、结构化、Chunking 策略与多模态内容处理。
- [万字详解 RAG 向量索引算法和向量数据库](./RAG向量存储.md)：掌握 HNSW、IVFFLAT 等索引算法原理，学会选择合适的向量数据库。
- [万字详解 RAG 检索优化](./RAG检索优化.md)：围绕 Chunk 策略、Hybrid Search、Query Rewrite、Rerank、上下文压缩排查召回问题。
- [万字详解 GraphRAG](./GraphRAG详解.md)：理解知识图谱驱动的 RAG，掌握实体、关系、社区发现、全局检索与局部检索。
