...
![RAG 文档处理总链路：上传前半段决定了后半段效果上限](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-overall-link.png)
...
![如何选择合适的切分策略？](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-chunking-strategy.png)
...
![什么是语义丢失？本质上是上下文依赖关系被切碎了](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-semantic-loss.png)
...
![结构丢失问题：不同格式，坑完全不一样](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-structure-loss.png)
...
![分层校验策略：没有质检的管线，不是生产级管线](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-hierarchical-verification-strategy.png)
...
![如何从零搭一套企业级文档处理管线？](https://oss.javaguide.cn/github/项目介绍/AI/rag/rag-document-processing-build-enterprise-document-processing-pipeline-from-scratch.png)
