...
![上下文窗口（Context Window）= LLM 的「工作记忆」](https://oss.javaguide.cn/github/项目介绍/AI/llm/llm-context-window.png)
...
![Temperature 参数：控制模型输出的随机性](https://oss.javaguide.cn/github/项目介绍/AI/llm/llm-temperature-params.png)
