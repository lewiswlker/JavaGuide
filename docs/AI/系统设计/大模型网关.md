...
![传统 API 网关示意图](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/api-gateway-overview.png)
...
![LLM 网关示意图](https://oss.javaguide.cn/github/项目介绍/AI/llm/llm-gateway-overview.png)
