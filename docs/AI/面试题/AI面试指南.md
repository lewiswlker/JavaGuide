...
| ---------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- |
| [大模型基础面试题总结](./大模型面试题.md)      | 所有准备 AI 应用开发面试的人                           | Token、上下文窗口、采样参数、API 调用、流式输出、结构化输出、Function Calling、AI 应用评测                                 |
| [AI Agent 面试题总结](./Agent面试题.md)        | 准备 Agent、工具调用、工作流相关岗位的人               | Agent Loop、Memory、Prompt Engineering、Context Engineering、MCP、Agent Skills、Harness Engineering、Workflow、Graph、Loop |
| [RAG 面试题总结](./RAG面试题.md)               | 准备知识库问答、企业 AI 应用、搜索增强生成相关岗位的人 | RAG 基础、Embedding、向量数据库、Chunk 策略、Hybrid Search、Query Rewrite、Rerank、GraphRAG、知识库更新与评测              |
| [AI 系统设计面试题总结](./AI系统设计面试题.md) | 2 年以上开发者、准备社招和系统设计面试的人             | 生产级 AI 应用架构、模型网关、Prompt 管理、RAG、Memory、Tool Calling、可观测、评测、安全合规、实时语音 Agent               |
...
如果你发现自己只能背定义，讲不出生产里的影响，建议先看：[大模型基础面试题总结](./大模型面试题.md)。
...
系统设计题建议直接看：[AI 系统设计面试题总结](./AI系统设计面试题.md)。
...
- Token、上下文窗口、采样参数不清楚，就看 [《LLM 运行机制》](../大模型基础/大模型运行机制.md)。
- Function Calling、Structured Outputs、MCP 边界不清楚，就看 [《大模型结构化输出详解》](../大模型基础/结构化输出与函数调用.md) 和 [《万字拆解 MCP 协议》](../agent/MCP协议.md)。
- RAG 效果优化说不清楚，就看 [《万字详解 RAG 检索优化》](../rag/RAG检索优化.md)。
- 生产级 AI 应用架构说不清楚，就看 [《AI 应用系统设计》](../系统设计/AI应用系统设计.md)。
...
- [大模型基础面试题总结](./大模型面试题.md)
- [AI Agent 面试题总结](./Agent面试题.md)
- [RAG 面试题总结](./RAG面试题.md)
- [AI 系统设计面试题总结](./AI系统设计面试题.md)
