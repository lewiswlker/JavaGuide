...
参考文章：[《AI Agent 核心概念：Agent Loop、Context Engineering、Tools 注册》](../agent/Agent核心概念.md)
...
![AI Agent 核心架构](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-core-arch.png)

![Agent Loop 工作流程](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-loop-flow.png)

## Agent Memory

参考文章：[《AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制》](../agent/Agent记忆系统.md)
...
![Agent 记忆分类全景图](https://oss.javaguide.cn/github/项目介绍/AI/agent/agent-memory-memory-taxonomy.svg)

## Prompt 与 Context Engineering

参考文章：[《大模型提示词工程实践指南》](../agent/提示词工程.md)、[《上下文工程实战指南：让 Agent 少犯蠢的工程方法论》](../agent/上下文工程.md)
...
参考文章：[《深入理解 MCP 协议：一次开发，多处复用》](../agent/MCP协议.md)、[《Agent Skills 是什么？和 Prompt、MCP 到底差在哪？》](../agent/Agent-Skills.md)
...
参考文章：[《一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战》](../agent/Harness工程.md)
...
![Harness 和 Prompt/Context Engineering 的关系](https://oss.javaguide.cn/github/项目介绍/AI/harness/harness-engineering-layers-arch.png)

## Workflow、Graph 与 Loop

参考文章：[《AI 工作流中的 Workflow、Graph 与 Loop：从概念到实现》](../agent/AI工作流.md)
