...
1. [AI 编程开放性面试题](./实践经验/AI编程开放性面试题.md)：先看面试会怎么问，也顺便校准自己到底会不会用。
2. [AI 编程选 CLI 还是 IDE？](./实践经验/CLI还是IDE.md)：把工具路线分清楚，别一上来就陷入工具名之争。
3. [Claude Code 使用指南](./实践经验/Claude-Code使用指南.md)、[Claude Code 核心命令详解](./实践经验/Claude-Code命令.md)：如果你主用 Claude Code，这两篇可以直接当操作手册看。
4. [CLAUDE.md 最佳实践](./实践经验/CLAUDE.md最佳实践.md)、[AI 编程必备 Skills 推荐](./实践经验/AI编程必备Skills.md)：开始处理项目规则、上下文管理、Skills 沉淀这些更长期的问题。
5. [OpenAI Codex 最佳实践指南](./实践经验/Codex最佳实践.md)、[Spec Coding 规范驱动编程](./实践经验/规范驱动编程.md)、[Vibe Coding 实用技巧总结](./实践经验/Vibe-Coding技巧.md)：把提示词、权限、Spec、Git 和多 Agent 工作流串起来。
...
- [AI 编程开放性面试题](./实践经验/AI编程开放性面试题.md)：把 Cursor、Claude Code 等工具怎么用、AI 对后端开发有什么影响这些问题放在一起讲。
- [AI 编程选 CLI 还是 IDE？](./实践经验/CLI还是IDE.md)：对比 Claude Code、Cursor、Kiro、Trae 等工具，重点看 CLI 和 IDE 到底适合什么活。
- [Spec Coding 规范驱动编程](./实践经验/规范驱动编程.md)：系统梳理 Vibe Coding 和 Spec Coding 的区别，从四步落地到多代理协作的完整实战指南。
- [Vibe Coding 实用技巧总结](./实践经验/Vibe-Coding技巧.md)：涵盖 Git 版本控制、Spec 范围管理、Skill 沉淀、多模型分工、上下文管理、多 Agent 协作和权限控制等实战经验。

### Claude Code 与 Codex 实战

- [Claude Code 使用指南](./实践经验/Claude-Code使用指南.md)：从配置、能力扩展到常用工作流，适合刚开始认真用 Claude Code 的读者。
- [CLAUDE.md 最佳实践](./实践经验/CLAUDE.md最佳实践.md)：讲清 `CLAUDE.md` 该写什么、不该写什么，项目变大后怎么和 `.claude/rules/`、Auto Memory 配合。
- [Claude Code 核心命令详解](./实践经验/Claude-Code命令.md)：专门讲 `/simplify`、`/review`、`/loop`、`/batch` 这些命令怎么用。
- [AI 编程必备 Skills 推荐](./实践经验/AI编程必备Skills.md)：整理 TDD、代码审查、UI 设计、网页自动化和 Skill 开发这些常用工作流。
- [OpenAI Codex 最佳实践指南](./实践经验/Codex最佳实践.md)：讲 Codex 云端智能体和 CLI 怎么配提示词、工具权限和安全策略。
- [Claude Code Agent View 多会话管理](./实践经验/Claude-Code-AgentView.md)：多 Agent 并行时，最怕状态乱、权限确认乱，这篇主要解决这个问题。
...
- [IDEA + CC GUI 插件实战](./项目/Claude-Code-GUI实战.md)：想在 IDEA 里用 GUI 管 Claude Code 和 Codex，可以看这个开源插件案例。
...
- [系统设计](../系统设计/)
- [系统设计基础](../系统设计/基础/)
- [Java 基础常见面试题](../java/基础/Java基础常见面试题01.md)
- [常用开发工具](../开发工具/)
