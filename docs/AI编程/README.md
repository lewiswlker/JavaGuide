...
1. [AI 编程开放性面试题](./实践经验/ai-ide.md)：先看面试会怎么问，也顺便校准自己到底会不会用。
2. [AI 编程选 CLI 还是 IDE？](./实践经验/cli-vs-ide.md)：把工具路线分清楚，别一上来就陷入工具名之争。
3. [Claude Code 使用指南](./实践经验/claudecode-tips.md)、[Claude Code 核心命令详解](./实践经验/claudecode-commands.md)：如果你主用 Claude Code，这两篇可以直接当操作手册看。
4. [CLAUDE.md 最佳实践](./实践经验/claude-md-best-practices.md)、[AI 编程必备 Skills 推荐](./实践经验/programmer-essential-skills.md)：开始处理项目规则、上下文管理、Skills 沉淀这些更长期的问题。
5. [OpenAI Codex 最佳实践指南](./实践经验/codex-best-practices.md)、[Spec Coding 规范驱动编程](./实践经验/spec-coding.md)、[Vibe Coding 实用技巧总结](./实践经验/the-cool-tricks-for-vibe-coding.md)：把提示词、权限、Spec、Git 和多 Agent 工作流串起来。
...
- [AI 编程开放性面试题](./实践经验/ai-ide.md)：把 Cursor、Claude Code 等工具怎么用、AI 对后端开发有什么影响这些问题放在一起讲。
- [AI 编程选 CLI 还是 IDE？](./实践经验/cli-vs-ide.md)：对比 Claude Code、Cursor、Kiro、Trae 等工具，重点看 CLI 和 IDE 到底适合什么活。
- [Spec Coding 规范驱动编程](./实践经验/spec-coding.md)：系统梳理 Vibe Coding 和 Spec Coding 的区别，从四步落地到多代理协作的完整实战指南。
- [Vibe Coding 实用技巧总结](./实践经验/the-cool-tricks-for-vibe-coding.md)：涵盖 Git 版本控制、Spec 范围管理、Skill 沉淀、多模型分工、上下文管理、多 Agent 协作和权限控制等实战经验。

### Claude Code 与 Codex 实战

- [Claude Code 使用指南](./实践经验/claudecode-tips.md)：从配置、能力扩展到常用工作流，适合刚开始认真用 Claude Code 的读者。
- [CLAUDE.md 最佳实践](./实践经验/claude-md-best-practices.md)：讲清 `CLAUDE.md` 该写什么、不该写什么，项目变大后怎么和 `.claude/rules/`、Auto Memory 配合。
- [Claude Code 核心命令详解](./实践经验/claudecode-commands.md)：专门讲 `/simplify`、`/review`、`/loop`、`/batch` 这些命令怎么用。
- [AI 编程必备 Skills 推荐](./实践经验/programmer-essential-skills.md)：整理 TDD、代码审查、UI 设计、网页自动化和 Skill 开发这些常用工作流。
- [OpenAI Codex 最佳实践指南](./实践经验/codex-best-practices.md)：讲 Codex 云端智能体和 CLI 怎么配提示词、工具权限和安全策略。
- [Claude Code Agent View 多会话管理](./实践经验/claudecode-agentview.md)：多 Agent 并行时，最怕状态乱、权限确认乱，这篇主要解决这个问题。

### 真实项目案例

- [IDEA 搭配 Qoder 插件实战](./实战案例/idea-qoder-plugin.md)：看 AI 怎么在 JetBrains IDE 里做接口优化和代码重构。
- [Trae + MiniMax 多场景实战](./实战案例/trae-m2.7.md)：用 Redis 故障排查、跨语言重构这些场景，看 AI 辅助编程能做到哪一步。
- [Claude Code 接入第三方模型实战](./实战案例/cc-glm5.1.md)：通过 GLM-5.1 做 JVM 智能诊断助手和慢查询治理。
- [DeepSeek V4 + Claude Code 实战](./实战案例/deepseek-v4-claude-code.md)：实测代码审计、Flyway 集成、多模型协同这些更贴近项目的任务。
- [MiniMax M3 + Claude Code 实战](./实战案例/cc-m3.md)：用线上 Redis SCAN 故障排查、SCAN 游标算法跨语言复刻、监控面板搭建三个案例实测 M3。
- [IDEA + CC GUI 插件实战](./项目/cc-guide.md)：想在 IDEA 里用 GUI 管 Claude Code 和 Codex，可以看这个开源插件案例。
...
- [系统设计](../系统设计/)
- [系统设计基础](../系统设计/基础/)
- [Java 基础常见面试题](../java/基础/java-basic-questions-01.md)
- [常用开发工具](../开发工具/)
