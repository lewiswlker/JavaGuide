...
你好，我是小 G。前几天分享 [Claude Code 使用技巧](https://javaguide.cn/AI编程/claudecode-tips.html) 的时候，我提到了一个很重要的文件 `CLAUDE.md`，并简单介绍了一下。
...
![CLAUDE.md 与其他规则文件怎么分工](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/claude-md-best-practices-rule-files-relationship.png)
...
![Spec Coding 规范驱动编程流水线](https://oss.javaguide.cn/github/项目介绍/AI/coding/spec-coding-pipeline-flow.png)

上图中的 `requirements.md` 就是 `Specify` 阶段的产物，也被称为 `SPEC.md` 。

我在[Spec Coding 规范驱动编程实战：从 Vibe Coding 到 AI 代码规范](https://javaguide.cn/AI编程/spec-coding.html)这篇文章中有详细介绍。
...
![Claude Code 官方文档对 CLAUDE.md 的建议](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/claudemd-claude-docs.png)
...
![andrej-karpathy-claudemd](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/andrej-karpathy-claudemd.png)
...
另一个例子是我的 [interview-guide](https://javaguide.cn/星球专栏/interview-guide.html)。它属于项目级 `CLAUDE.md`，重点不是把文档写长，而是把 Claude 容易猜错、代码里又读不完整的信息放到一眼能扫到的位置：技术栈版本、分层边界、命名后缀、异常处理、事务规则、禁止清单。
...
![CLAUDE.md 层级与优先级](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/claude-md-best-practices-file-hierarchy.png)
...
![CLAUDE.md 组织方式演进](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/claude-md-best-practices-scaling-evolution.png)
...
![CLAUDE.md 维护决策流程](https://oss.javaguide.cn/github/项目介绍/AI/coding/claudecode/claude-md-best-practices-maintenance-flow.png)
