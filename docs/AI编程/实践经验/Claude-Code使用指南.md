...
你好，我是小 G。前几天分享了一篇 [Vibe Coding 实用技巧总结](./Vibe-Coding技巧.md)，反响很不错，公众号阅读一天时间就冲上了 6w+。
...
![MCP 图解](https://oss.javaguide.cn/github/项目介绍/AI/skills/mcp-simple-diagram.png)
...
[AI 编程必备 Skills 推荐](https://javaguide.cn/AI编程/programmer-essential-skills.html)中推荐的 Superpowers 就把 TDD 给封装好了。
...
命令细节我在 [Claude Code 核心命令详解：simplify、code-review、loop、batch、run、verify](https://javaguide.cn/AI编程/claudecode-commands.html) 这篇里展开写过，这里就不重复铺太长了。
...
[AI 编程必备 Skills 推荐](https://javaguide.cn/AI编程/programmer-essential-skills.html)中也有推荐前端相关的开源 Skills。
