...
- [Java 学习路线（最新版，4w+ 字）](./面试准备/java-roadmap.md)
- [程序员简历编写指南](./面试准备/resume-guide.md)
- [项目经验指南](./面试准备/project-experience-guide.md)
- [面试太紧张怎么办？](./面试准备/how-to-handle-interview-nerves.md)
- [校招没有实习经历怎么办？实习经历怎么写？](./面试准备/internship-experience.md)
...
- [ArrayList 核心源码+扩容机制分析](./java/集合/arraylist-source-code.md)
- [LinkedList 核心源码分析](./java/集合/linkedlist-source-code.md)
- [HashMap 核心源码+底层数据结构分析](./java/集合/hashmap-source-code.md)
- [ConcurrentHashMap 核心源码+底层数据结构分析](./java/集合/concurrent-hash-map-source-code.md)
- [LinkedHashMap 核心源码分析](./java/集合/linkedhashmap-source-code.md)
- [CopyOnWriteArrayList 核心源码分析](./java/集合/copyonwritearraylist-source-code.md)
- [ArrayBlockingQueue 核心源码分析](./java/集合/arrayblockingqueue-source-code.md)
- [PriorityQueue 核心源码分析](./java/集合/priorityqueue-source-code.md)
- [DelayQueue 核心源码分析](./java/集合/priorityqueue-source-code.md)
...
- [乐观锁和悲观锁详解](./java/并发/optimistic-lock-and-pessimistic-lock.md)
- [CAS 详解](./java/并发/cas.md)
...
- [Java 9 新特性概览](./java/新特性/java9.md)
- [Java 10 新特性概览](./java/新特性/java10.md)
- [Java 11 新特性概览](./java/新特性/java11.md)
- [Java 12 & 13 新特性概览](./java/新特性/java12-13.md)
- [Java 14 & 15 新特性概览](./java/新特性/java14-15.md)
- [Java 16 新特性概览](./java/新特性/java16.md)
- [Java 17 新特性概览](./java/新特性/java17.md)
- [Java 18 新特性概览](./java/新特性/java18.md)
- [Java 19 新特性概览](./java/新特性/java19.md)
- [Java 20 新特性概览](./java/新特性/java20.md)
- [Java 21 新特性概览](./java/新特性/java21.md)
- [Java 22 & 23 新特性概览](./java/新特性/java22-23.md)
- [Java 24 新特性概览](./java/新特性/java24.md)
- [Java 25 新特性概览](./java/新特性/java25.md)
...
- **[MySQL 常见知识点&面试题总结](./数据库/mysql/mysql-questions-01.md)** (必看 :+1:)
- [MySQL 高性能优化规范建议总结](./数据库/mysql/mysql-high-performance-optimization-specification-recommendations.md)

**重要知识点：**

- [MySQL 索引详解](./数据库/mysql/mysql-index.md)
- [MySQL 索引失效场景总结](./数据库/mysql/mysql-index-invalidation.md)
- [MySQL 事务隔离级别图文详解)](./数据库/mysql/transaction-isolation-level.md)
- [MySQL 三大日志(binlog、redo log 和 undo log)详解](./数据库/mysql/mysql-logs.md)
- [InnoDB 存储引擎对 MVCC 的实现](./数据库/mysql/innodb-implementation-of-mvcc.md)
...
- [Redis 常见知识点&面试题总结(上)](./数据库/redis/redis-questions-01.md)
- [Redis 常见知识点&面试题总结(下)](./数据库/redis/redis-questions-02.md)

**重要知识点：**

- [3 种常用的缓存读写策略详解](./数据库/redis/3-commonly-used-cache-read-and-write-strategies.md)
- [Redis 能做消息队列吗？怎么实现？](./数据库/redis/redis-stream-mq.md)
- [Redis 5 种基本数据结构详解](./数据库/redis/redis-data-structures-01.md)
- [Redis 3 种特殊数据结构详解](./数据库/redis/redis-data-structures-02.md)
- [Redis 持久化机制详解](./数据库/redis/redis-persistence.md)
...
[Elasticsearch 常见面试题总结(付费)](./数据库/elasticsearch/elasticsearch-questions-01.md)
...
- [Maven 核心概念总结](./开发工具/maven/maven-core-concepts.md)
- [Maven 最佳实践](./开发工具/maven/maven-best-practices.md)
...
- [Docker 核心概念总结](./开发工具/docker/docker-intro.md)
- [Docker 实战](./开发工具/docker/docker-in-action.md)
...
- [RestFul API 简明教程](./系统设计/基础/RESTfulAPI.md)
- [软件工程简明教程](./系统设计/基础/software-engineering.md)
- [代码命名指南](./系统设计/基础/naming.md)
- [代码重构指南](./系统设计/基础/refactoring.md)
...
- [Spring 常见知识点&面试题总结](./系统设计/常用框架/spring/spring-knowledge-and-questions-summary.md)
- [SpringBoot 常见知识点&面试题总结](./系统设计/常用框架/spring/springboot-knowledge-and-questions-summary.md)
- [Spring/Spring Boot 常用注解总结](./系统设计/常用框架/spring/spring-common-annotations.md)
- [SpringBoot 入门指南](https://github.com/Snailclimb/springboot-guide)

**重要知识点详解**：

- [IoC & AOP 详解（快速搞懂）](./系统设计/常用框架/spring/ioc-and-aop.md)
- [Spring 事务详解](./系统设计/常用框架/spring/spring-transaction.md)
- [Spring 中的设计模式详解](./系统设计/常用框架/spring/spring-design-patterns-summary.md)
- [SpringBoot 自动装配原理详解](./系统设计/常用框架/spring/spring-boot-auto-assembly-principles.md)

#### MyBatis

[MyBatis 常见面试题总结](./系统设计/常用框架/mybatis/mybatis-interview.md)

### 安全

#### 认证授权

- [认证授权基础概念详解](./系统设计/安全/basis-of-authority-certification.md)
- [JWT 基础概念详解](./系统设计/安全/jwt-intro.md)
- [JWT 优缺点分析以及常见问题解决方案](./系统设计/安全/advantages-and-disadvantages-of-jwt.md)
- [SSO 单点登录详解](./系统设计/安全/sso-intro.md)
- [权限系统设计详解](./系统设计/安全/design-of-authority-system.md)

#### 数据安全

- [常见加密算法总结](./系统设计/安全/encryption-algorithms.md)
- [敏感词过滤方案总结](./系统设计/安全/sentive-words-filter.md)
- [数据脱敏方案总结](./系统设计/安全/data-desensitization.md)
- [为什么前后端都要做数据校验](./系统设计/安全/data-validation.md)
- [为什么忘记密码时只能重置，不能告诉你原密码？](./系统设计/安全/why-password-reset-instead-of-retrieval.md)
...
- [CAP 理论和 BASE 理论解读](./分布式系统/理论与协议/cap-and-base-theorem.md)
- [Paxos 算法解读](./分布式系统/理论与协议/paxos-algorithm.md)
- [Raft 算法解读](./分布式系统/理论与协议/raft-algorithm.md)
- [ZAB 协议解读](./分布式系统/理论与协议/zab.md)
- [Gossip 协议详解](./分布式系统/理论与协议/gossip-protocol.md)
- [一致性哈希算法详解](./分布式系统/理论与协议/consistent-hashing.md)
...
- [ZooKeeper 相关概念总结(入门)](./分布式系统/分布式协调/zookeeper/zookeeper-intro.md)
- [ZooKeeper 相关概念总结(进阶)](./分布式系统/分布式协调/zookeeper/zookeeper-plus.md)

### API 网关

- [API 网关基础知识总结](./分布式系统/api-gateway.md)
- [Spring Cloud Gateway 常见知识点&面试题总结](./分布式系统/spring-cloud-gateway-questions.md)
...
- [消息队列基础知识总结](./高性能/消息队列/message-queue.md)
- [Disruptor 常见知识点&面试题总结](./高性能/消息队列/disruptor-questions.md)
- [RabbitMQ 常见知识点&面试题总结](./高性能/消息队列/rabbitmq-questions.md)
- [RocketMQ 常见知识点&面试题总结](./高性能/消息队列/rocketmq-questions.md)
- [Kafka 常见知识点&面试题总结](./高性能/消息队列/kafka-questions-01.md)
