...
![BIO、NIO 和 AIO 对比](https://oss.javaguide.cn/github/项目介绍/java/nio/bio-aio-nio.png)
...
![Buffer、Channel和Selector三者之间的关系](https://oss.javaguide.cn/github/项目介绍/java/nio/channel-buffer-selector.png)
...
![Buffer 的子类](https://oss.javaguide.cn/github/项目介绍/java/nio/buffer-subclasses.png)
...
![position 、limit 和 capacity 之前的关系](https://oss.javaguide.cn/github/项目介绍/java/nio/JavaNIOBuffer.png)

![position 、limit 和 capacity 之前的关系](https://oss.javaguide.cn/github/项目介绍/java/nio/NIOBufferClassAttributes.png)
...
![capacity、limit和position每一阶段的变化](https://oss.javaguide.cn/github/项目介绍/java/nio/NIOBufferClassAttributesDataChanges.png)
...
![Channel 和 Buffer之间的关系](https://oss.javaguide.cn/github/项目介绍/java/nio/channel-buffer.png)

另外，因为 Channel 是全双工的，所以它可以比流更好地映射底层操作系统的 API。特别是在 UNIX 网络编程模型中，底层操作系统的通道都是全双工的，同时支持读写操作。

`Channel` 的子类如下图所示。

![Channel 的子类](https://oss.javaguide.cn/github/项目介绍/java/nio/channel-subclasses.png)
...
![Channel继承关系图](https://oss.javaguide.cn/github/项目介绍/java/nio/channel-inheritance-relationship.png)
...
![Selector 选择器工作示意图](https://oss.javaguide.cn/github/项目介绍/java/nio/selector-channel-selectionkey.png)
