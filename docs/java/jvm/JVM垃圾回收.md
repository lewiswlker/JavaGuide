...
关于堆空间结构更详细的介绍，可以回过头看看 [Java 内存区域详解](./运行时数据区.md) 这篇文章。
...
通过以下方式运行：
![](https://oss.javaguide.cn/github/项目介绍/java/jvm/25178350.png)

添加的参数：`-XX:+PrintGCDetails`
![](https://oss.javaguide.cn/github/项目介绍/java/jvm/run-with-PrintGCDetails.png)

运行结果 (红色字体描述有误，应该是对应于 JDK1.7 的永久代)：

![](https://oss.javaguide.cn/github/项目介绍/java/jvm/28954286.jpg)
...
![](https://oss.javaguide.cn/github/项目介绍/java/jvm/28128785.jpg)
...
![R 大的回答](https://oss.javaguide.cn/github/项目介绍/java/jvm/rf-hotspot-vm-gc.png)
...
![对象之间循环引用](https://oss.javaguide.cn/github/项目介绍/java/jvm/object-circular-reference.png)
...
![可达性分析算法](https://oss.javaguide.cn/github/项目介绍/java/jvm/jvm-gc-roots.png)
...
![Java 引用类型总结](https://oss.javaguide.cn/github/项目介绍/java/jvm/java-reference-type.png)
...
![标记-清除算法](https://oss.javaguide.cn/github/项目介绍/java/jvm/mark-and-sweep-garbage-collection-algorithm.png)
...
![复制算法](https://oss.javaguide.cn/github/项目介绍/java/jvm/copying-garbage-collection-algorithm.png)
...
![标记-整理算法](https://oss.javaguide.cn/github/项目介绍/java/jvm/mark-and-compact-garbage-collection-algorithm.png)
...
![Serial 收集器](https://oss.javaguide.cn/github/项目介绍/java/jvm/serial-garbage-collector.png)
...
![ParNew 收集器 ](https://oss.javaguide.cn/github/项目介绍/java/jvm/parnew-garbage-collector.png)
...
![Parallel Old收集器运行示意图](https://oss.javaguide.cn/github/项目介绍/java/jvm/parallel-scavenge-garbage-collector.png)
...
![CMS 收集器](https://oss.javaguide.cn/github/项目介绍/java/jvm/cms-garbage-collector.png)
...
![G1 收集器](https://oss.javaguide.cn/github/项目介绍/java/jvm/g1-garbage-collector.png)
