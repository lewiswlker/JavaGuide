...
![类加载过程](https://oss.javaguide.cn/github/项目介绍/java/jvm/class-loading-procedure.png)
...
![类加载器层次关系图](https://oss.javaguide.cn/github/项目介绍/java/jvm/class-loader-parents-delegation-model.png)
...
![Tomcat 的类加载器的层次结构](https://oss.javaguide.cn/github/项目介绍/java/jvm/tomcat-class-loader-parents-delegation-model.png)
