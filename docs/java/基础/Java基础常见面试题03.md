...
![Java 异常类层次结构图](https://oss.javaguide.cn/github/项目介绍/java/基础/types-of-exceptions-in-java.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/基础/checked-exception.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/基础/unchecked-exception.png)
...
关于 Java 代理的详细介绍，可以看看笔者写的 [Java 代理模式详解](https://javaguide.cn/java/基础/proxy.html “Java 代理模式详解”)这篇文章。
...
![](https://oss.javaguide.cn/github/项目介绍/a478c74d-2c48-40ae-9374-87aacf05188c.png)
...
关于这些语法糖的详细解读，请看这篇文章 [Java 语法糖详解](./语法糖.md) 。
