...
![JMM(Java 内存模型)](https://oss.javaguide.cn/github/项目介绍/java/并发/jmm.png)

![JMM(Java 内存模型)强制在主存中进行读取](https://oss.javaguide.cn/github/项目介绍/java/并发/jmm2.png)
...
![JUC原子类概览](https://oss.javaguide.cn/github/项目介绍/java/JUC%E5%8E%9F%E5%AD%90%E7%B1%BB%E6%A6%82%E8%A7%88-20230814005211968.png)
...
![JUC原子类概览](https://oss.javaguide.cn/github/项目介绍/java/JUC%E5%8E%9F%E5%AD%90%E7%B1%BB%E6%A6%82%E8%A7%88.png)
...
![synchronized关键字原理](https://oss.javaguide.cn/github/项目介绍/java/并发/synchronized-principle.png)
...
![执行 monitorenter 获取锁](https://oss.javaguide.cn/github/项目介绍/java/并发/synchronized-get-lock-code-block.png)

对象锁的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](https://oss.javaguide.cn/github/项目介绍/java/并发/synchronized-release-lock-block.png)
...
![synchronized关键字原理](https://oss.javaguide.cn/github/项目介绍/synchronized%E5%85%B3%E9%94%AE%E5%AD%97%E5%8E%9F%E7%90%862.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/reentrantlock-class-diagram.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/reentrantreadwritelock-class-diagram.png)
...
Atomic 原子类部分的内容我单独写了一篇文章来总结：[Atomic 原子类总结](./原子类.md) 。
