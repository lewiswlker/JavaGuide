...
![ThreadLocal 数据结构](https://oss.javaguide.cn/github/项目介绍/java/并发/threadlocal-data-structure.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](https://oss.javaguide.cn/github/项目介绍/java/并发/thread-local-inner-class.png)
...
![TTL 官方提供的 CRR 整个过程的时序图](https://oss.javaguide.cn/github/项目介绍/java/并发/ttl-crr-timing-diagram.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/threadpoolexecutor-construtors.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/executors-new-thread-pool-methods.png)
...
![线程池各个参数的关系](https://oss.javaguide.cn/github/项目介绍/java/并发/relationship-between-thread-pool-parameters.png)
...
![调整阻塞队列大小和最大线程数](https://oss.javaguide.cn/github/项目介绍/java/并发/threadpool-reject-2-threadpool-reject-01.png)
...
![将一部分任务保存到MySQL中](https://oss.javaguide.cn/github/项目介绍/java/并发/threadpool-reject-2-threadpool-reject-02.png)
...
![图解线程池实现原理](https://oss.javaguide.cn/github/项目介绍/java/并发/thread-pool-principle.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/threadpoolexecutor-methods.png)
...
![动态配置线程池参数最终效果](https://oss.javaguide.cn/github/项目介绍/java/并发/meituan-dynamically-configuring-thread-pool-parameters.png)

还没看够？我在[《后端面试高频系统设计&场景题》](https://javaguide.cn/星球专栏/back-end-interview-high-frequency-system-design-and-scenario-questions.html)中详细介绍了如何设计一个动态线程池，这也是面试中常问的一道系统设计题。
...
![ThreadPoolExecutor构造函数](https://oss.javaguide.cn/github/项目介绍/java/并发/common-parameters-of-threadpool-workqueue.jpg)
...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/completablefuture-class-diagram.jpg)
...
![](https://oss.javaguide.cn/项目介绍/image-20210902093026059.png)
...
![CLH 锁的队列结构](https://oss.javaguide.cn/github/项目介绍/开源项目/clh-lock-queue-structure.png)
...
![CLH 变体队列结构](https://oss.javaguide.cn/github/项目介绍/java/并发/clh-queue-structure-bianti.png)

AQS(`AbstractQueuedSynchronizer`)的核心原理图：

![CLH 变体队列](https://oss.javaguide.cn/github/项目介绍/java/并发/clh-queue-state.png)
