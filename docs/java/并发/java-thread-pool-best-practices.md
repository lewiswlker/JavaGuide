...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/threadpool-methods-information.png)
...
![案例代码概览](https://oss.javaguide.cn/github/项目介绍/java/并发/production-accident-threadpool-sharing-example.png)
...
![线程池使用不当导致死锁](https://oss.javaguide.cn/github/项目介绍/java/并发/production-accident-threadpool-sharing-deadlock.png)
