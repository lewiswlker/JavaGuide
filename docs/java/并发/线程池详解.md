...
![](https://oss.javaguide.cn/github/项目介绍/java/并发/executor-class-diagram.png)
...
![Executor 框架的使用示意图](./图片/java-thread-pool-summary/Executor框架的使用示意图.png)
...
![FixedThreadPool的execute()方法运行示意图](./图片/java-thread-pool-summary/FixedThreadPool.png)
...
![SingleThreadExecutor的运行示意图](./图片/java-thread-pool-summary/SingleThreadExecutor.png)
...
![CachedThreadPool的execute()方法的执行示意图](./图片/java-thread-pool-summary/CachedThreadPool-execute.png)
