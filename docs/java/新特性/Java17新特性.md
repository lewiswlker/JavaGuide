...
![](https://oss.javaguide.cn/github/项目介绍/java/新特性/4c1611fad59449edbbd6e233690e9fa7.png)
...
在 [Java 14 & 15 新特性概览](./Java14-15新特性.md) 中，我有详细介绍到密封类，这里就不再做额外的介绍了。
...
在 [Java 18 新特性概览](./Java18新特性.md) 中，我有详细介绍到向量 API，这里就不再做额外的介绍了。
