...
![ JDK 8 到 JDK 25 每个版本的更新带来的新特性数量和更新时间](https://oss.javaguide.cn/github/项目介绍/java/新特性/jdk8~jdk24.png)
...
**注意**：不要把记录模式和 [JDK16](./Java16新特性.md) 正式引入的记录类搞混了。
...
在 [Java 19 新特性概览](./Java19新特性.md) 中，我有详细介绍到外部函数和内存 API，这里就不再做额外的介绍了。
...
![虚拟线程、平台线程和系统内核线程的关系](https://oss.javaguide.cn/github/项目介绍/java/新特性/virtual-threads-platform-threads-kernel-threads-relationship.png)
