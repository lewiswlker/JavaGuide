...
![](https://oss.javaguide.cn/github/项目介绍/java/新特性/jdk22-new-features.png)
...
![Markdown 文档注释](https://oss.javaguide.cn/github/项目介绍/java/新特性/jep467-markdown-documentation-comments.png)
...
关于这个新特性的详细介绍，可以看看[Java 21 新特性概览(重要)](./Java21新特性.md)这篇文章中的介绍。
