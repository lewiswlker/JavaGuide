...
`LinkedList` 是一个基于双向链表实现的集合类，经常被拿来和 `ArrayList` 做比较。关于 `LinkedList` 和`ArrayList`的详细对比，我们 [Java 集合常见面试题总结(上)](./Java集合常见面试题01.md)有详细介绍到。
...
![LinkedList 类图](https://oss.javaguide.cn/github/项目介绍/java/集合/linkedlist--class-diagram.png)
