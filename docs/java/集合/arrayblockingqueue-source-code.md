...
![ArrayBlockingQueue 类图](https://oss.javaguide.cn/github/项目介绍/java/集合/arrayblockingqueue-class-diagram.png)
...
![ArrayBlockingQueue 非空条件](https://oss.javaguide.cn/github/项目介绍/java/集合/ArrayBlockingQueue-notEmpty-take.png)
...
![ArrayBlockingQueue 非满条件](https://oss.javaguide.cn/github/项目介绍/java/集合/ArrayBlockingQueue-notFull-put.png)
...
![ArrayBlockingQueue 非空非满](https://oss.javaguide.cn/github/项目介绍/java/集合/ArrayBlockingQueue-notEmpty-notFull.png)
...
![](https://oss.javaguide.cn/github/项目介绍/java/集合/ArrayBlockingQueue-get-add-element-methods.png)
