...
![Java 7 ConcurrentHashMap 存储结构](https://oss.javaguide.cn/github/项目介绍/java/集合/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](https://oss.javaguide.cn/github/项目介绍/java/集合/java8_concurrenthashmap.png)
