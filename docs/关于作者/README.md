...
![](https://oss.javaguide.cn/项目介绍/%E4%B8%AA%E4%BA%BA%E4%BB%8B%E7%BB%8D.png)

## 我坚持写了多久博客？

时间真快啊！我自己是从大二开始写博客的。那时候就是随意地在博客平台上发发自己的学习笔记和自己写的程序。就比如 [谢希仁老师的《计算机网络》内容总结](../计算机基础/计算机网络/computer-network-xiexiren-summary.md) 这篇文章就是我在大二学习计算机网络这门课的时候对照着教材总结的。
...
![](https://oss.javaguide.cn/项目介绍/psc.jpeg)
