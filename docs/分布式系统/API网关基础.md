...
![](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/up-35e102c633bbe8e0dea1e075ea3fee5dcfb.png)
...
![Zuul 核心架构](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/zuul-core-architecture.webp)

Zuul 主要通过过滤器（类似于 AOP）来过滤请求，从而实现网关必备的各种功能。

![Zuul 请求生命周期](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/api-gateway/zuul-request-lifecycle.webp)
...
![Zuul2 架构](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/zuul2-core-architecture.png)
...
![OpenResty 和 Nginx 以及 Lua 的关系](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/api-gatewaynginx-lua-openresty.png)
...
![](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/api-gateway/kong-way.webp)
...
![](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/api-gateway/kong-gateway-overview.png)
...
![APISIX 架构图](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/apisix-architecture.png)
...
![](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/up-a240d3b113cde647f5850f4c7cc55d4ff5c.png)
...
![ShenYu 架构](https://oss.javaguide.cn/github/项目介绍/分布式系统/api-gateway/shenyu-architecture.png)
