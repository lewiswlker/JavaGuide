...
![文库会员支付示例](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/distributed-id-design-pay-one-card.png)
...
![优惠编码兑换奖品](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/distributed-id-design-coupon.png)
...
![在分布式链路跟踪](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/distributed-id-design-tracing.png)
...
![短网址作用](https://oss.javaguide.cn/github/项目介绍/系统设计/分布式系统/distributed-id-design-short-url.png)
