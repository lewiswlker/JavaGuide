...
![共享资源未互斥访问导致出现问题](https://oss.javaguide.cn/github/项目介绍/分布式系统/distributed-lock/oversold-without-locking.png)
...
![本地锁](https://oss.javaguide.cn/github/项目介绍/分布式系统/distributed-lock/jvm-local-lock.png)
...
![分布式锁](https://oss.javaguide.cn/github/项目介绍/分布式系统/distributed-lock/distributed-lock.png)
