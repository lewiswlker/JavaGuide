...
1. [有了 HTTP 协议，为什么还要 RPC？](../../计算机基础/计算机网络/http-vs-rpc.md)：先厘清 HTTP 与 RPC 的关系。
...
- [有了 HTTP 协议，为什么还要 RPC？](../../计算机基础/计算机网络/http-vs-rpc.md)：解释 HTTP 与 RPC 的关系，避免把 RPC 简单理解成“比 HTTP 更高级的协议”。
