...
1. [有了 HTTP 协议，为什么还要 RPC？](../../计算机基础/计算机网络/HTTP与RPC对比.md)：先厘清 HTTP 与 RPC 的关系。
2. [RPC 远程过程调用详解](./RPC基础.md)：再系统理解 RPC 调用流程、核心组件和框架选型。
3. [Dubbo 面试题总结](./Dubbo面试题.md)：最后把 RPC 放到 Dubbo 这种成熟框架里，看服务治理和生产实践。

## 核心文章

- [RPC 远程过程调用详解](./RPC基础.md)：从调用流程、动态代理、序列化协议、网络传输和服务发现等角度理解 RPC 的基本原理。
- [Dubbo 面试题总结](./Dubbo面试题.md)：串联 Dubbo 架构原理、服务暴露与引用、SPI 扩展机制、负载均衡、集群容错、注册中心和生产实践问题。
- [有了 HTTP 协议，为什么还要 RPC？](../../计算机基础/计算机网络/HTTP与RPC对比.md)：解释 HTTP 与 RPC 的关系，避免把 RPC 简单理解成“比 HTTP 更高级的协议”。
...
- [分布式系统知识体系](../)
- [API 网关详解](../API网关基础.md)
- [Spring Cloud Gateway 面试题总结](../Spring-Cloud-Gateway面试题.md)
- [计算机网络](../../计算机基础/计算机网络/)
