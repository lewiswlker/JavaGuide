...
![连接 ZooKeeper 服务](https://oss.javaguide.cn/github/项目介绍/分布式系统/zookeeper/connect-zooKeeper-service.png)
...
上面显示的一些信息比如 cversion、aclVersion、numChildren 等等，我在上面 “[ZooKeeper 相关概念总结(入门)](https://javaguide.cn/分布式系统/分布式协调/zookeeper/zookeeper-intro.html)” 这篇文章中已经介绍到。
...
![](https://oss.javaguide.cn/github/项目介绍/分布式系统/zookeeper/curator.png)
...
我们在 [ZooKeeper 常见概念解读](./ZooKeeper入门.md) 中介绍到，我们通常是将 znode 分为 4 大类：
