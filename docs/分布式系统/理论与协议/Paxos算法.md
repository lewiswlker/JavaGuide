...
![《Paxos Made Simple》](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/paxos-made-simple.png)
...
由于 Paxos 算法公认难以理解和实现，2013 年诞生了更易理解的 [Raft 算法](https://javaguide.cn/分布式系统/theorem&algorithm&protocol/raft-algorithm.html)。
...
![Basic Paxos中的角色](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/up-890fa3212e8bf72886a595a34654918486c.png)
