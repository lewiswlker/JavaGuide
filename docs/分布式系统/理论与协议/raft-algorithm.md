...
![共识算法架构](https://oss.javaguide.cn/github/项目介绍/paxos-rsm-architecture.png)
...
![Raft 服务器状态转换示意图](https://oss.javaguide.cn/github/项目介绍/paxos-server-state.png)

### 2.2 任期

![任期（term）示意图](https://oss.javaguide.cn/github/项目介绍/paxos-term.png)
...
![Raft 任期逻辑演进 (Term Progression)](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/raft-term-progression.png)
...
![Raft Leader 选举流程](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/raft-election.png)
