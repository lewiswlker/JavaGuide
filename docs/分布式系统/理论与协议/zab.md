...
![ZXID 结构](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/zab-zxid-structure.png)
...
![ZAB 消息广播模式](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/zab-message-broadcast-flow.png)
...
![zab-crash-recovery-flow](https://oss.javaguide.cn/github/项目介绍/分布式系统/理论与协议/zab-crash-recovery-flow.png)
