...
![Maven 仓库](https://oss.javaguide.cn/github/项目介绍/开发工具/maven/mvnrepository.com.png)
...
![](https://oss.javaguide.cn/github/项目介绍/开发工具/maven/maven-plugins.png)
...
![](https://oss.javaguide.cn/github/项目介绍/开发工具/maven/dubbo-maven-multi-module.png)
