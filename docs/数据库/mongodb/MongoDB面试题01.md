...
![MongoDB 文档](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/crud-annotated-document..png)
...
![BSON 官网首页](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/bsonspec.org.png)

#### 集合

MongoDB 集合存在于数据库中，**没有固定的结构**，也就是 **无模式** 的，这意味着可以往集合插入不同格式和类型的数据。不过，通常情况下，插入集合中的数据都会有一定的关联性。

![MongoDB 集合](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/crud-annotated-collection.png)
...
![WiredTiger B+树整体结构](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/mongodb-b-plus-tree-integral-structure.png)
...
![管道的工作流程](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/mongodb-aggregation-stage.png)
...
关于事务的详细介绍这篇文章就不多说了，感兴趣的可以看看我写的[MySQL 常见面试题总结](../mysql/MySQL常见面试题.md)这篇文章，里面有详细介绍到。
