...
![](https://oss.javaguide.cn/github/项目介绍/数据库/mysql20210513092328171.png)
...
![](https://oss.javaguide.cn/github/项目介绍/数据库/mysql20210513092224836.png)
...
![斜树](https://oss.javaguide.cn/github/项目介绍/计算机基础/数据结构/oblique-tree.png)
...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/数据结构/avl-tree.png)
...
![红黑树](https://oss.javaguide.cn/github/项目介绍/计算机基础/数据结构/red-black-tree.png)
...
![主键索引](https://oss.javaguide.cn/github/项目介绍/开源项目/cluster-index.png)
...
![二级索引](https://oss.javaguide.cn/github/项目介绍/开源项目/no-cluster-index.png)
...
![MySQL 表的文件](https://oss.javaguide.cn/github/项目介绍/数据库/mysql20210420165311654.png)

聚簇索引和非聚簇索引：

![聚簇索引和非聚簇索引](https://oss.javaguide.cn/github/项目介绍/数据库/mysql20210420165326946.png)
...
![覆盖索引](https://oss.javaguide.cn/github/项目介绍/数据库/mysql20210420165341868.png)
...
![](https://oss.javaguide.cn/github/项目介绍/mysql/not-using-covering-index-demo.png)
...
![](https://oss.javaguide.cn/github/项目介绍/mysql/using-covering-index-demo.png)

通过 `Extra` 这一列的 `Using index`，说明这条 SQL 语句成功使用了覆盖索引。

关于 `EXPLAIN` 命令的详细介绍请看：[MySQL 执行计划分析](./MySQL执行计划.md)这篇文章。
...
![](https://oss.javaguide.cn/github/项目介绍/数据库/mysql/index-condition-pushdown.png)

![](https://oss.javaguide.cn/github/项目介绍/数据库/mysql/index-condition-pushdown-graphic-illustration.png)
...
篇幅问题，我这里只是简单介绍了一下 MySQL 执行计划，详细介绍请看：[MySQL 执行计划分析](./MySQL执行计划.md)这篇文章。
