...
![](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/sql-nosql-tushi.png)
...
![NoSQL 数据模型](https://oss.javaguide.cn/github/项目介绍/数据库/mongodb/types-of-nosql-datastores.png)
