...
![Redis 数据类型概览](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-overview-of-data-types-2023-09-28.jpg)

Redis 没有外部依赖，Linux 和 OS X 是 Redis 开发和测试最多的两个操作系统，官方推荐生产环境使用 Linux 部署 Redis。

个人学习的话，你可以自己本机安装 Redis 或者通过 Redis 官网提供的[在线 Redis 环境](https://try.redis.io/)（少部分命令无法使用）来实际体验 Redis。

![try-redis](https://oss.javaguide.cn/github/项目介绍/数据库/redis/try.redis.io.png)
...
![why-redis-so-fast](https://oss.javaguide.cn/github/项目介绍/数据库/redis/why-redis-so-fast.png)
...
- **分布式锁**：通过 Redis 来做分布式锁是一种比较常见的方式。通常情况下，我们都是基于 Redisson 来实现分布式锁。关于 Redis 实现分布式锁的详细介绍，可以看我写的这篇文章：[分布式锁详解](https://javaguide.cn/分布式系统/distributed-lock.html)。
...
关于 Redis 实现分布式锁的详细介绍，可以看我写的这篇文章：[分布式锁详解](https://javaguide.cn/分布式系统/distributed-lock-implementations.html)。
...
关于 Redis 实现延时任务的详细介绍，可以看我写的这篇文章：[如何基于 Redis 实现延时任务？](./Redis延时任务.md)。
...
![Hash维护简单的购物车信息](https://oss.javaguide.cn/github/项目介绍/数据库/redis/hash-shopping-cart.png)
...
![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/2021060714195385.png)

[《Java 面试指北》](https://javaguide.cn/星球专栏/java-mian-shi-zhi-bei.html) 的「技术面试题篇」就有一篇文章详细介绍如何使用 Sorted Set 来设计制作一个排行榜，感兴趣的小伙伴可以看看。

![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/image-20220719071115140.png)
...
另外，我还单独写了一篇文章从有序集合的基本使用到跳表的源码分析和实现，让你会对 Redis 的有序集合底层实现的跳表有着更深刻的理解和掌握：[Redis 为什么用跳表实现有序集合](https://javaguide.cn/数据库/redis/redis-skiplist.html)。
...
![img](https://oss.javaguide.cn/github/项目介绍/数据库/redis/image-20220720194154133.png)
...
![Bloom Filter 的简单原理示意图](https://oss.javaguide.cn/github/项目介绍/计算机基础/算法/bloom-filter-simple-schematic-diagram.png)
...
![文件事件处理器（file event handler）](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-event-handler.png)
...
![redis4.0 more thread](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis4.0-more-thread.png)
...
![Redis 过期字典](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-expired-dictionary.png)
...
![redis.conf 对于 hz 的注释](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis.conf-hz.png)
