...
![Redis 事务](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-transactions.png)
...
![Redis 为什么不支持回滚](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-rollback.png)
...
![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-pipeline-vs-transaction.png)
...
![bigkey 判定标准](https://oss.javaguide.cn/github/项目介绍/数据库/redis/bigkey-criterion.png)
...
在 [Redis 常见阻塞原因总结](./Redis常见阻塞问题.md) 这篇文章中我们提到：大 key 还会造成阻塞问题。具体来说，主要体现在下面三个方面：
...
![阿里云Key分析](https://oss.javaguide.cn/github/项目介绍/数据库/redis/aliyun-key-analysis.png)
...
![京东零售开源的 hotkey](https://oss.javaguide.cn/github/项目介绍/数据库/redis/jd-hotkey.png)
...
![通过阿里云的Proxy Query Cache优化热点Key问题](https://oss.javaguide.cn/github/项目介绍/数据库/redis/aliyun-hotkey-proxy-query-cache.png)
...
![缓存穿透](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-cache-penetration.png)
...
![位数组](https://oss.javaguide.cn/github/项目介绍/计算机基础/算法/bloom-filter-bit-table.png)

具体是这样做的：把所有可能存在的请求的值都存放在布隆过滤器中，当用户请求过来，先判断用户发来的请求的值是否存在于布隆过滤器中。不存在的话，直接返回请求参数错误信息给客户端，存在的话才会走下面的流程。

加入布隆过滤器之后的缓存处理流程图如下：

![加入布隆过滤器之后的缓存处理流程图](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-cache-penetration-bloom-filter.png)
...
![缓存击穿](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-cache-breakdown.png)
...
![缓存雪崩](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-cache-avalanche.png)
...
![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/cache-aside-write.png)

![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/cache-aside-read.png)
