...
![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/chrome-clear-cache.png)
...
![本地缓存示意图](https://oss.javaguide.cn/github/项目介绍/数据库/redis/local-cache.png)
...
![分布式缓存](https://oss.javaguide.cn/github/项目介绍/数据库/redis/distributed-cache.png)
...
![多级缓存](https://oss.javaguide.cn/项目介绍/数据库/redis/multilevel-cache.png)
