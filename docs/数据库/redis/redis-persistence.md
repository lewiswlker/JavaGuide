...
![](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis4.0-persitence.png)
...
![Redis 持久化机制完整流程](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-persistence-flow.png)
...
![AOF 工作基本流程](https://oss.javaguide.cn/github/项目介绍/数据库/redis/aof-work-process.png)
...
![AOF 记录日志过程](https://oss.javaguide.cn/github/项目介绍/数据库/redis/redis-aof-write-log-disc.png)
...
![AOF 重写](https://oss.javaguide.cn/github/项目介绍/数据库/redis/aof-rewrite.png)
