...
2. [系统设计基础专题](./基础/)：补齐 RESTful API、软件工程、代码命名、代码重构和单元测试。
3. [设计模式常见面试题总结](./design-pattern.md)：理解常见设计模式适合解决哪些变化点。
4. [Spring & Spring Boot 专题](./常用框架/spring/)：掌握 IoC、AOP、事务、自动装配、常用注解和框架设计模式。
5. [认证授权与数据安全专题](./安全/)：系统理解认证授权、JWT、SSO、权限系统、加密、脱敏和数据校验。
