...
![](https://oss.javaguide.cn/github/项目介绍/image-20220311155746549.png)
...
![常见的设计模式](https://oss.javaguide.cn/github/项目介绍/系统设计/基础/common-design-patterns.png)

更全面的设计模式总结，可以看 **[java-design-patterns](https://github.com/iluwatar/java-design-patterns)** 这个开源项目。

**常见的软件设计原则如下**：

![常见的软件设计原则](https://oss.javaguide.cn/github/项目介绍/系统设计/基础/programming-principles.png)
...
![](https://oss.javaguide.cn/github/项目介绍/bad&good-design.png)
...
![refractor-two-hats](https://oss.javaguide.cn/github/项目介绍/refractor-two-hats.png)
