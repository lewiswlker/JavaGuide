...
我在 [JWT 优缺点分析](./JWT优缺点.md)这篇文章中有详细介绍到使用 JWT 做身份认证的优势和劣势。
...
![JWT 组成](https://oss.javaguide.cn/项目介绍/系统设计/jwt/jwt-composition.png)
...
![](https://oss.javaguide.cn/项目介绍/系统设计/jwt/jwt.io.png)
