...
![内存管理主要做的事情](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/memory-management-roles.png)
...
![内存碎片](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/internal-and-external-fragmentation.png)
...
![伙伴系统（Buddy System）内存管理](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/linux-buddy-system.png)
...
![伙伴系统内存浪费问题](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/buddy-system-memory-waste.png)
...
![地址翻译过程](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/physical-virtual-address-translation.png)
...
![分段机制下的地址翻译过程](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/segment-virtual-address-composition.png)
...
![分段机制导致外部内存碎片](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/segment-external-memory-fragmentation.png)
...
![单级页表](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/page-table.png)
...
![分页机制下的地址翻译过程](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/paging-virtual-address-composition.png)
...
![多级页表](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/multilevel-page-table.png)
...
![加入 TLB 之后的地址翻译](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/physical-virtual-address-translation-mmu.png)
...
![使用 TLB 之后的地址翻译流程](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/page-table-tlb.png)
...
![常见的页面置换算法](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/image-20230409113009139.png)
...
![常见的磁盘调度算法](https://oss.javaguide.cn/github/项目介绍/计算机基础/操作系统/disk-scheduling-algorithms.png)
