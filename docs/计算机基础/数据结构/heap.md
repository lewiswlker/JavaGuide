...
![堆-插入元素-1](./图片/堆/堆-插入元素1.png)

> 有能力的人会逐渐升职加薪，是金子总会发光的！！！

**2. 从底向上，如果父结点比该元素小，则该节点和父结点交换，直到无法交换**

![堆-插入元素2](./图片/堆/堆-插入元素2.png)

![堆-插入元素3](./图片/堆/堆-插入元素3.png)
...
![删除堆顶元素4](./图片/堆/删除堆顶元素4.png)

然后开始将这个石头沉入海底，不停与左右子节点的值进行比较，和较大的子节点交换位置，直到无法交换位置。

![删除堆顶元素5](./图片/堆/删除堆顶元素5.png)

![删除堆顶元素6](./图片/堆/删除堆顶元素6.png)
