...
![TCP/IP 各层协议概览](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/network-protocol-overview.png)
...
![Root-Servers.org](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/root-servers-org.png)
...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/DNS-process.png)
...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/DNS-process2.png)
...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/DNS-packet.png)
...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/20210506174303797.png)

`TTL` 是该记录的生存时间，它决定了资源记录应当从缓存中删除的时间。

`Name` 和 `Value` 字段的取值取决于 `Type`：

![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/20210506170307897.png)
