...
![TCP 三次握手图解](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-shakes-hands-three-times.png)
...
![TCP 四次挥手图解](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-waves-four-times.png)
...
![TCP 连接建立与关闭的常见状态迁移路径](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-state-diagram.png)
...
这部分内容已单独成文，详见 [TCP TIME_WAIT 详解：为什么要等、会不会出问题、能不能复用？](./TCP-TIME-WAIT详解.md)。
