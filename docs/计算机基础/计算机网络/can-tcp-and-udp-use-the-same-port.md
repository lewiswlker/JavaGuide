...
![端口什么情况下会冲突](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/when-does-tcp-conflict-occur.png)
...
![HTTP/3 协议栈实现](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/http-3-implementation.png)
