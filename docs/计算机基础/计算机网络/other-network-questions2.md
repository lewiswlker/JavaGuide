...
![TCP 与 UDP 的消息边界](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-udp-byte-stream-tcp-udp-message-boundary.png)
...
![TCP 粘包 / 拆包为什么会出现？](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-udp-byte-stream-tcp-sticky-split-causes.png)
...
![应用层如何定义消息边界？](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/tcp-udp-byte-stream-tcp-message-boundary-solutions.png)
...
![内核协议分发流程](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/can-tcp-and-udp-use-the-same-port-kernel-protocol-dispatching-process.png)
...
![实际应用示例](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/can-tcp-and-udp-use-the-same-port-practical-application-example.png)
...
![IP 地址使数据包到达其目的地](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/internet_protocol_ip_address_diagram.png)
...
![IPv4](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/Figure-1-IPv4Addressformatwithdotteddecimalnotation-29c824f6a451d48d8c27759799f0c995.png)
...
![IPv6](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/Figure-2-IPv6Addressformatwithhexadecimalnotation-7da3a419bd81627a9b2cef3b0efb4940.png)
...
![NAT 实现 IP地址转换](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/network-address-translation.png)
...
![路由器的背面就会注明 MAC 位址](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/router-back-will-indicate-mac-address.png)
