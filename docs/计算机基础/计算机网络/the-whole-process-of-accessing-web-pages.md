...
![](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/five-layers.png)
...
![URL的组成结构](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/URL-parts.png)
...
![DNS 解析流程](https://oss.javaguide.cn/github/项目介绍/计算机基础/计算机网络/DNS-process.png)
