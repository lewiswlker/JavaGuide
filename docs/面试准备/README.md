...
1. [2026 最新版 Java 后端面试通关计划](./后端面试通关计划.md)：先建立 4-8 周复习路线和阶段目标。
2. [如何高效准备 Java 面试？](./如何高效准备面试.md)：理解求职导向学习、技能清单和复习方法。
3. [程序员简历编写指南](./简历指南.md) 和 [项目经验指南](./项目经验指南.md)：先把简历和项目经历打磨到可深挖。
4. [2026 最新版 Java 后端面试重点总结](./面试重点.md)：按高频考点集中补技术短板。
5. [常见面试题自测](./常见面试题自测.md)、[优质面经汇总](./面试经验.md)：通过自测和面经做查漏补缺。
6. [面试太紧张怎么办？](./面试紧张应对.md)：面试前补齐心态、表达和临场应对。

## 核心文章

### 复习计划与学习路线

- [2026 最新版 Java 后端面试通关计划](./后端面试通关计划.md)：按项目经历、Java/MySQL/Redis、框架、系统设计、计算机基础、分布式和 JVM 编排复习节奏。
- [如何高效准备 Java 面试？](./如何高效准备面试.md)：讲清面试准备方法、求职导向学习、技能清单和冲刺策略。
- [2026 最新版 Java 学习路线](./Java学习路线.md)：从 Java 基础到数据库、缓存、中间件、框架和面试重点，适合长期补基础。

### 简历与项目经验

- [程序员简历编写指南](./简历指南.md)：从简历筛选逻辑出发，讲清简历结构、技能描述、项目经历和模板选择。
- [项目经验指南](./项目经验指南.md)：帮助没有项目或项目平淡的同学补强项目亮点，学会复盘和表达。
- [校招没有实习经历怎么办？实习经历怎么写？](./实习经历指南.md)：讲清实习缺失时如何通过项目、简历和技术面试弥补短板。

### 技术重点与资料

- [2026 最新版 Java 后端面试重点总结](./面试重点.md)：梳理 Java 基础、集合、并发、MySQL、Redis、Spring、JVM 和项目经验等高频重点。
- [2026 最新 Java 面试 + 后端面试 PDF 资料](./pdf-interview-javaguide.md)：整理 JavaGuide 后端面试 PDF 资料，适合集中复习和离线查阅。
- [常见面试题自测](./常见面试题自测.md)：按面试提问方式整理高频问题，适合面前自查掌握程度。

### 面经复盘与临场状态

- [优质面经汇总](./面试经验.md)：通过真实面经理解不同公司、不同轮次的提问方式和复盘方法。
- [面试太紧张怎么办？](./面试紧张应对.md)：从心态调整、准备方式、模拟面试和面后复盘降低临场焦虑。
