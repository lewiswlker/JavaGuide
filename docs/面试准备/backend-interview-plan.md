...
1. **实战项目视频/专栏**：慕课网、哔哩哔哩、拉勾、极客时间等；选择适合自己能力的项目，不必强求微服务项目。[JavaGuide 官方知识星球](https://javaguide.cn/关于作者/zhishixingqiu-two-years.html)已经推出[⭐AI 智能面试辅助平台 + RAG 知识库](https://javaguide.cn/星球专栏/interview-guide.html)和[手写 RPC 框架](https://javaguide.cn/星球专栏/handwritten-rpc-framework.html)。并且，还分享了很多高频项目经历（如博客、外卖、线程池、短连接）的优化版介绍和面试准备。
...
- [Spring 常见面试题](https://javaguide.cn/系统设计/常用框架/spring/spring-knowledge-and-questions-summary.html)、[SpringBoot 常见面试题](https://javaguide.cn/系统设计/常用框架/spring/springboot-knowledge-and-questions-summary.html)
- [常用注解](https://javaguide.cn/系统设计/常用框架/spring/spring-common-annotations.html)、[IoC 与 AOP](https://javaguide.cn/系统设计/常用框架/spring/ioc-and-aop.html)、[Spring 事务](https://javaguide.cn/系统设计/常用框架/spring/spring-transaction.html)
- [Spring 中的设计模式](https://javaguide.cn/系统设计/常用框架/spring/spring-design-patterns-summary.html)、[SpringBoot 自动装配](https://javaguide.cn/系统设计/常用框架/spring/spring-boot-auto-assembly-principles.html)、[Async 原理](https://javaguide.cn/系统设计/常用框架/spring/async.html)（原理性知识，时间不够可跳过）
- [MyBatis 常见面试题](https://javaguide.cn/系统设计/常用框架/mybatis/mybatis-interview.html)（不重要，可跳过，考查不多）、[Netty 常见面试题](https://javaguide.cn/系统设计/常用框架/netty.html)（用到才需要准备）
...
- **系统设计 / 场景题汇总**：[系统设计常见面试题总结](https://javaguide.cn/系统设计/system-design-questions.html)（付费内容在 [《后端面试高频系统设计&场景题》](https://javaguide.cn/星球专栏/back-end-interview-high-frequency-system-design-and-scenario-questions.html) 专栏，含短链、秒杀、海量数据处理等 30+ 道）。
...
- **算法与代码题**（面字节、快手等必留时间）：[剑指 Offer 题解](https://javaguide.cn/计算机基础/算法/the-sword-refers-to-offer.html)、LeetCode 热题 100、常见手写（如 LRU、生产者消费者、单例等）。建议每天至少 1 道，保持手感。
...
- **数据结构**：[数组/链表/栈/队列](https://javaguide.cn/计算机基础/数据结构/linear-data-structure.html)、[图](https://javaguide.cn/计算机基础/数据结构/graph.html)、[堆](https://javaguide.cn/计算机基础/数据结构/heap.html)、[树](https://javaguide.cn/计算机基础/数据结构/tree.html)、[红黑树](https://javaguide.cn/计算机基础/数据结构/red-black-tree.html)、[布隆过滤器](https://javaguide.cn/计算机基础/数据结构/bloom-filter.html)
...
- **RPC**：[RPC 基础](https://javaguide.cn/分布式系统/rpc/rpc-intro.html)、[Dubbo](https://javaguide.cn/分布式系统/rpc/dubbo.html)（目前问的很少，可跳过）
- **分布式 ID / 网关 / 锁 / 事务**（项目涉及再重点看）：[分布式 ID](https://javaguide.cn/分布式系统/distributed-id.html)、[设计指南](https://javaguide.cn/分布式系统/distributed-id-design.html)、[API 网关](https://javaguide.cn/分布式系统/api-gateway.html)、[Spring Cloud Gateway](https://javaguide.cn/分布式系统/spring-cloud-gateway-questions.html)、[分布式锁](https://javaguide.cn/分布式系统/distributed-lock-implementations.html)、[分布式事务](https://javaguide.cn/分布式系统/distributed-transaction.html)
