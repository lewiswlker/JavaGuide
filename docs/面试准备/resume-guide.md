...
::: tip 友情提示
本文节选自 **[《Java 面试指北》](../星球专栏/java-mian-shi-zhi-bei.md)**。这是一份教你如何更高效地准备面试的小册，涵盖常见八股文（系统设计、常见框架、分布式、高并发 ……）、优质面经等内容。
:::
...
![](https://oss.javaguide.cn/github/项目介绍/面试准备/46c92fbc5160e65dd85c451143177144.png)
...
项目经历这部分对于简历来说非常重要，[《Java 面试指北》](https://javaguide.cn/星球专栏/java-mian-shi-zhi-bei.html)的面试准备篇有好几篇关于优化项目经历的文章，建议你仔细阅读一下，应该会对你有帮助。
...
![](https://oss.javaguide.cn/github/项目介绍/面试准备/project-experience-avoiding-ambiguity-descriptio.png)
