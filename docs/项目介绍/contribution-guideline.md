...
![](https://oss.javaguide.cn/github/项目介绍/about/javaguide-contribution-edit-page.png)
...
![](https://oss.javaguide.cn/github/项目介绍/about/javaguide-contribution-pr.png)

Git 相关的技能非常重要，建议在正式工作之前一定要熟练掌握。

我写过两篇相关的文章，推荐看看：

- [Git 核心概念总结](https://javaguide.cn/开发工具/git/git-intro.html)
- [Github 实用小技巧总结](https://javaguide.cn/开发工具/git/github-tips.html)
