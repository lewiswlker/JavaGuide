...
>
> **详细介绍：** [CAP & BASE理论详解](https://javaguide.cn/分布式系统/理论与协议/cap-and-base-theorem.html)。
...
![Sentinel：blockHandler 与 Fallback 的区别](https://oss.javaguide.cn/github/项目介绍/高可用/fallback-and-circuit-breaker-blockHandler-vs-Fallback.png)
...
![请求保护流程](https://oss.javaguide.cn/github/项目介绍/高可用/fallback-and-circuit-breaker-request-protection-process.png)
