...
![雪崩效应传播](https://oss.javaguide.cn/github/项目介绍/高可用/fallback-and-circuit-breaker-avalanche-effect-spread.png)
...
![熔断器状态机](https://oss.javaguide.cn/github/项目介绍/高可用/fallback-and-circuit-breaker-fuse-state-machine.png)
...
![隔离策略对比](https://oss.javaguide.cn/github/项目介绍/高可用/fallback-and-circuit-breaker-isolation-strategy-comparison.png)
...
![超时机制](https://oss.javaguide.cn/github/项目介绍/高可用/timeout-mechanism-overview.png)
...
![重试前必须先判断：错误类型 + 操作幂等](https://oss.javaguide.cn/github/项目介绍/高可用/timeout-and-retry-optimized-retry-idempotency-decision.png)
