...
![超时预算在微服务链路中的传递](https://oss.javaguide.cn/github/项目介绍/高可用/timeout-and-retry-optimized-timeout-budget-chain.png)
...
![重试机制](https://oss.javaguide.cn/github/项目介绍/高可用/retry-mechanism-overview.png)
...
![四种重试策略时间线对比](https://oss.javaguide.cn/github/项目介绍/高可用/timeout-and-retry-optimized-retry-strategies-timeline.png)
...
![重试风暴：请求量级联放大](https://oss.javaguide.cn/github/项目介绍/高可用/timeout-and-retry-optimized-retry-storm-cascade.png)
