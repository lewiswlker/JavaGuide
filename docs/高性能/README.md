...
4. [消息队列基础知识总结](./消息队列/message-queue.md)：理解异步处理、解耦、削峰、消息可靠性、顺序性和幂等。
5. 再根据技术栈深入 [Kafka 常见问题总结](./消息队列/kafka-questions-01.md)、[RocketMQ 常见问题总结](./消息队列/rocketmq-questions.md)、[RabbitMQ 常见问题总结](./消息队列/rabbitmq-questions.md)。
...
- [消息队列基础知识总结](./消息队列/message-queue.md)：理解应用场景、消息模型、消息可靠性、顺序性、幂等和积压处理。
- [Kafka 常见问题总结](./消息队列/kafka-questions-01.md)：掌握 Kafka 架构、高性能原理、消息可靠性、顺序性和 Rebalance。
- [RocketMQ 常见问题总结](./消息队列/rocketmq-questions.md)：理解 RocketMQ 架构、消息类型、存储机制、可靠性和 5.x 新特性。
- [RabbitMQ 常见问题总结](./消息队列/rabbitmq-questions.md)：理解 AMQP、Exchange 类型、确认机制、死信队列、延迟队列和镜像队列。
- [Disruptor 常见问题总结](./消息队列/disruptor-questions.md)：理解 RingBuffer、Sequencer、WaitStrategy、无锁设计和缓存行填充。
