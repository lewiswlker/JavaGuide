...
![CDN 简易示意图](https://oss.javaguide.cn/github/项目介绍/高性能/cdn/cdn-101.png)
...
![CDN 缓存的完整生命周期](https://oss.javaguide.cn/github/项目介绍/高性能/cdn/cdn-full-life-cycle-of-cdn-cache.png)
...
![CDN 缓存的刷新和预热](https://oss.javaguide.cn/github/项目介绍/高性能/cdn/cdn-refresh-warm-up.png)
...
![多服务实例-负载均衡](https://oss.javaguide.cn/github/项目介绍/高性能/load-balancing/multi-service-load-balancing.drawio.png)
...
![基于 Nginx 的服务端负载均衡](https://oss.javaguide.cn/github/项目介绍/高性能/load-balancing/server-load-balancing.png)
...
![Dubbo 加权轮询负载均衡算法](https://oss.javaguide.cn/github/项目介绍/高性能/load-balancing/dubbo-round-robin-load-balance.png)
...
![读写分离示意图](https://oss.javaguide.cn/github/项目介绍/高性能/read-and-write-separation-and-library-subtable/read-and-write-separation.png)
...
![代理方式实现读写分离](https://oss.javaguide.cn/github/项目介绍/高性能/read-and-write-separation-and-library-subtable/read-and-write-separation-proxy.png)
...
![垂直分库](./图片/read-and-write-separation-and-library-subtable/vertical-slicing-database.png)

![水平分库](./图片/read-and-write-separation-and-library-subtable/horizontal-slicing-database.png)

![分表](./图片/read-and-write-separation-and-library-subtable/two-forms-of-sub-table.png)
...
![ShardingSphere 提供的功能](https://oss.javaguide.cn/github/项目介绍/高性能/shardingsphere-features.png)
...
![尽量避免多表做 join](https://oss.javaguide.cn/github/项目介绍/mysql/alibaba-java-development-handbook-multi-table-join.png)
...
![深度分页问题](https://oss.javaguide.cn/github/项目介绍/mysql/deep-pagination-phenomenon.png)
...
![转全表扫描的临界点](https://oss.javaguide.cn/github/项目介绍/mysql/deep-pagination-phenomenon-critical-point.png)

![阿里巴巴 Java 开发手册分页建议](https://oss.javaguide.cn/github/项目介绍/mysql/alibaba-java-development-handbook-paging.png)
...
![冷热分离 - 冷数据迁移](https://oss.javaguide.cn/github/项目介绍/高性能/data-cold-hot-separation.png)
...
![通过异步处理提高系统性能](https://oss.javaguide.cn/github/项目介绍/Asynchronous-message-queue.png)

![削峰](https://oss.javaguide.cn/github/项目介绍/%E5%89%8A%E5%B3%B0-%E6%B6%88%E6%81%AF%E9%98%9F%E5%88%97.png)
...
![消息队列解耦商城示例](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/message-queue-decouple-mall-example.png)
...
![队列模型](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/message-queue-queue-model.png)

![发布/订阅（Pub/Sub）模型](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/message-queue-pub-sub-model.png)
...
![Kafka Topic 分区布局](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/KafkaTopicPartionsLayout.png)
...
![kafka offset](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/kafka-offset.jpg)
...
![RabbitMQ 4.0 核心架构与消息生命周期流转图](https://oss.javaguide.cn/github/项目介绍/高性能/rabbitmq/rabbitmq-core-architecture-and-message-lifecycle-flow.png)

常见 Exchange 类型包括 Direct、Fanout、Topic、Headers，其中 Direct 精确匹配，Fanout 广播，Topic 支持通配符匹配。

![RabbitMQ Exchange 四种类型对比](https://oss.javaguide.cn/github/项目介绍/高性能/rabbitmq/rabbitmq-exchange-types.png)

RabbitMQ 面试经常会继续追问消息可靠性，回答时可以按“生产者确认、交换机到队列路由、队列持久化、消费者 ACK、死信队列”这条链路来讲。

![RabbitMQ 4.0 消息可靠性与队列架构全景图](https://oss.javaguide.cn/github/项目介绍/高性能/rabbitmq/rabbitmq-message-reliability-and-queue-architecture-overview.png)

### Disruptor 和消息队列有什么区别？

Disruptor 是本地内存中的高性能并发框架，不是分布式消息队列。它通过 RingBuffer、无锁设计、缓存行填充等方式减少锁竞争和伪共享，适合单进程内的高性能事件处理。

![LMAX 系统使用 Disruptor 的示例](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/disruptor-models.png)
...
![Disruptor 等待策略](https://oss.javaguide.cn/github/项目介绍/高性能/消息队列/DisruptorWaitStrategy.png)
